...
namespace ChessNet.Data.Constants
{
    public static class InitialStates
    {
        public static IEnumerable<Piece> DEFAULT = new List<Piece>
        {
            ...
            // Black
            new Rook(PieceColor.Black, new BoardPosition(0, 6)),
            new Knight(PieceColor.Black, new BoardPosition(1, 6)),
            new Bishop(PieceColor.Black, new BoardPosition(2, 6)),
            new Queen(PieceColor.Black, new BoardPosition(3, 6)),
            new King(PieceColor.Black, new BoardPosition(4, 6)),
            new Bishop(PieceColor.Black, new BoardPosition(5, 6)),
            new Knight(PieceColor.Black, new BoardPosition(6, 6)),
            new Rook(PieceColor.Black, new BoardPosition(7, 6)),

            new Pawn(PieceColor.Black, new BoardPosition(0, 7)),
            new Pawn(PieceColor.Black, new BoardPosition(1, 7)),
            new Pawn(PieceColor.Black, new BoardPosition(2, 7)),
            new Pawn(PieceColor.Black, new BoardPosition(3, 7)),
            new Pawn(PieceColor.Black, new BoardPosition(4, 7)),
            new Pawn(PieceColor.Black, new BoardPosition(5, 7)),
            new Pawn(PieceColor.Black, new BoardPosition(6, 7)),
            new Pawn(PieceColor.Black, new BoardPosition(7, 7)),
        };
    }
}
